        ...
        <div className="flex items-center justify-center h-full">
            <div className="flex flex-col w-[20rem] gap-5 text-center">
                ...
                <div
                    ...
                    className="flex items-center justify-center h-[50px] text-sm cursor-pointer text-white font-bold bg-green-700 rounded-[0.25rem]">
                  계속하기
                </div>
                <div className="relative flex items-center w-full">
                    <a href="http://localhost:9892/oauth2/authorization/google" className="flex-1">구글</a>
