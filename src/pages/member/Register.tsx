    ...
    return (
        ...
        <div className="flex flex-col w-[20rem] gap-5 text-center">
            ...
            <div className="relative">
                ...
                { idFlag &&
                <IdBtnTrue className="w-1/4">검사 완료</IdBtnTrue>
                }
                { !idFlag &&
                <IdBtnFalse className="w-1/4"onClick={handleCheckId}>중복 검사</IdBtnFalse>
                }
            </div>
            <div className="relative">
                <input
            ...
            <div className="relative">
                ...
                <label
                    htmlFor="passwordCk"
                    className="absolute text-sm text-primary-dark duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">비밀번호 확인</label>
            </div>
            <div className="relative">
                <input
                    type="text"
