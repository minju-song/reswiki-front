    ...
    return (
        <div>
            ...
            <ResultDiv>
                ...
                <div>
                    <Restaurant>
                        <ResImg src={PHOTO_API_URL+`?photo_reference=${restaurant.restaurantImg}&maxheight=100&key=${API_KEY}`} />
                        <ResInfo>
                            <ResName>{restaurant.restaurantName}</ResName>
                            <ResInfoText>{restaurant.restaurantAddr1+' '+restaurant.restaurantAddr2}</ResInfoText>
                            <ResInfoText>{restaurant.restaurantTel}</ResInfoText>
                            <ResInfoText>{'리뷰 최근 업데이트일 : '+restaurant.restaurantUpdate}</ResInfoText>
                        </ResInfo>
                    </Restaurant>
                    <h3>리뷰 모음</h3>
                    <Reviews>
